            ...
            <div class="row">
                <div class="col-md-6 order-2 order-md-1">
                    ...
                    <div class="about-details pt-2">
                        <p class="para">
                            We are commited to building retail space, commercial buildings, and industrial projects for our clients.
                            We specialize in creating beautiful. Sturdy spaces that feel lime home right away all in accordance with our clients vision.
                        </P>
                ...
                <div class="col-md-6 d-flex justify-content-center order-1 order-md-2">
                    <div class="about-img  d-flex justify-content-center pb-4">
                        <img class="wow fadeIn w-100"  src="assets/images/about.png" alt="about-img">
                    </div>
                </div>
            </div>
            </div>
